...
public class PandoraTeleporter extends Teleporter
{
    ...
    public PandoraTeleporter(WorldServer par1WorldServer)
    {
            ...
            for (int l = -2; l <= 2; ++l)
            {
                for (int i1 = -2; i1 <= 2; ++i1)
                {
                    for (int j1 = -1; j1 < 3; ++j1)
                    {
                        ...
                        int i2 = k + i1 * b1 - l * b0;
                        boolean flag = j1 < 0;
                        this.field_85192_a.setBlock(k1, l1, i2,
                                flag ? Block.blockEmerald.blockID : 0);
                    }
                }
            }
            ...
            double par4, double par6, float par8)
    {
        ...
        if (this.field_85191_c.containsItem(j1))
        {
            ...
            portalposition.lastUpdateTime = this.field_85192_a
                    .getTotalWorldTime();
            flag = false;
        }
        else
        {
            for (k1 = l - short1; k1 <= l + short1; ++k1)
            {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                {
                    ...
                    {
                        if (this.field_85192_a.getBlockId(k1, i2, l1) == SixCoreModBlocks.pandoraPortal.blockID)
                        {
                            while (this.field_85192_a
                                    .getBlockId(k1, i2 - 1, l1) == SixCoreModBlocks.pandoraPortal.blockID)
                            {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D)
        {
            if (flag)
            {
                this.field_85191_c.add(j1, new PortalPosition(this, i, j, k,
                        this.field_85192_a.getTotalWorldTime()));
            ...
            if (this.field_85192_a.getBlockId(i - 1, j, k) == SixCoreModBlocks.pandoraPortal.blockID)
            {
                j2 = 2;
            }
            ...
            if (this.field_85192_a.getBlockId(i, j, k - 1) == SixCoreModBlocks.pandoraPortal.blockID)
            {
                j2 = 3;
            }
            ...
            if (j2 > -1)
            {
                ...
                boolean flag1 = !this.field_85192_a.isAirBlock(i + i3 + k3, j,
                        k + j3 + l3)
                        || !this.field_85192_a.isAirBlock(i + i3 + k3, j + 1, k
                                + j3 + l3);
                boolean flag2 = !this.field_85192_a.isAirBlock(i + i3, j, k
                        + j3)
                        || !this.field_85192_a
                                .isAirBlock(i + i3, j + 1, k + j3);
                ...
                if (flag1 && flag2)
                {
                    ...
                    int i4 = k - l3;
                    d4 -= (double) l3;
                    flag1 = !this.field_85192_a.isAirBlock(k1 + i3 + k3, j, i4
                            + j3 + l3)
                            || !this.field_85192_a.isAirBlock(k1 + i3 + k3,
                                    j + 1, i4 + j3 + l3);
                    flag2 = !this.field_85192_a.isAirBlock(k1 + i3, j, i4 + j3)
                            || !this.field_85192_a.isAirBlock(k1 + i3, j + 1,
                                    i4 + j3);
                }
            ...
            for (i2 = i - b0; i2 <= i + b0; ++i2)
            {
                ...
                for (j2 = k - b0; j2 <= k + b0; ++j2)
                {
                    ...
                    for (k2 = this.field_85192_a.getActualHeight() - 1; k2 >= 0; --k2)
                    {
                        ...
                        {
                            while (k2 > 0
                                    && this.field_85192_a.isAirBlock(i2,
                                            k2 - 1, j2))
                            {
                                --k2;
                            }
            ...
            for (k2 = -1; k2 <= 1; ++k2)
            {
                for (i3 = 1; i3 < 3; ++i3)
                {
                    for (l2 = -1; l2 < 3; ++l2)
                    {
                        ...
                        i4 = j2 + (i3 - 1) * l5 - k2 * k5;
                        flag = l2 < 0;
                        this.field_85192_a.setBlock(k3, j3, i4,
                                flag ? Block.blockEmerald.blockID : 0);
                    }
                }
            }
        ...
        for (k2 = 0; k2 < 4; ++k2)
        {
            for (i3 = 0; i3 < 4; ++i3)
            {
                for (l2 = -1; l2 < 4; ++l2)
                {
                    ...
                    this.field_85192_a.setBlock(k3, j3, i4,
                            flag ? Block.blockEmerald.blockID
                                    : SixCoreModBlocks.pandoraPortal.blockID,
                            0, 2);
                }
            }
            ...
            for (i3 = 0; i3 < 4; ++i3)
            {
                for (l2 = -1; l2 < 4; ++l2)
                {
                    ...
                    j3 = j5 + l2;
                    i4 = j2 + (i3 - 1) * l5;
                    this.field_85192_a.notifyBlocksOfNeighborChange(k3, j3, i4,
                            this.field_85192_a.getBlockId(k3, j3, i4));
                }
            }
        }
